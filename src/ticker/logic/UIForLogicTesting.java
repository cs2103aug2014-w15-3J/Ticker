...
public class UIForLogicTesting extends Application implements Observer {

	private static UIForLogicTesting ticker;
	private Logic logic;
	...
	public static UIForLogicTesting getTickerUI() {
		return ticker;
	}

	public UIForLogicTesting() {
		// Initialisation
		ticker = this;
